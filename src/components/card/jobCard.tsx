...
import { EJOB_TYPE, Job } from "@/types";

import Link from "next/link";
import Image from "next/image";

import { formatSalary, processJobTitle } from "@/lib/utils";
          ...
          <div className="flex flex-wrap items-center gap-6">
            <div className="flex items-center gap-2">
              ...
              <p className="body-medium text-light-500">
                {job_employment_type
                  ? EJOB_TYPE[job_employment_type as keyof typeof EJOB_TYPE]
                  : null}
              </p>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="body-medium text-light-500">
                {job_salary
                  ? formatSalary(Number(job_salary))
                  : "Not disclosed"}
              </p>
            </div>
          </div>
